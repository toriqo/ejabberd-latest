...
update_tables(State) ->
    ...
    drop_index(State, "i_vcard_search_lrole"),
    drop_index(State, "i_vcard_search_ldescription"),
    drop_index(State, "i_vcard_search_lkeyword"),
    ...
    create_index(State, "vcard_search", "i_vcard_search_sh_lrole",     ["server_host", "lrole"]),
    create_index(State, "vcard_search", "i_vcard_search_sh_ldescription",  ["server_host", "ldescription"]),
    create_index(State, "vcard_search", "i_vcard_search_sh_lkeyword",  ["server_host", "lkeyword"]),
